...
const css$2 = {
  code: '.footer-main.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6{background-color:#484c5a}@media(max-width: 550px){.footer-main.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6{padding-bottom:2em}}.footer-list.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6{display:flex;justify-content:space-around;padding-left:0;list-style-type:none;color:white}.footer-list.svelte-1bzupy6>li.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6{flex:1}@media(min-width: 551px){.footer-list.svelte-1bzupy6>li.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6{min-height:216px}.footer-list.svelte-1bzupy6>li.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6:not(:first-child):not(:nth-child(3)):not(:last-child){margin-left:2.4rem}}.footer-list.svelte-1bzupy6>li.svelte-1bzupy6>img.svelte-1bzupy6.svelte-1bzupy6{height:180px;margin:15px 0}.footer-list.svelte-1bzupy6>li.svelte-1bzupy6>h6.svelte-1bzupy6.svelte-1bzupy6{margin-top:35px;margin-bottom:10px}.footer-list.svelte-1bzupy6>li a.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6{display:block;font-size:15px;font-family:"Roboto";margin:6px 0;color:white;text-decoration:none}.footer-list.svelte-1bzupy6>li a.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6:hover{text-decoration:underline}@media(max-width: 1060px) and (min-width: 551px){.footer-list.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6{display:grid;grid-template-columns:repeat(2, 1fr);gap:1em;grid-auto-rows:minmax(100px, auto)}.footer-list.svelte-1bzupy6>li.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6:nth-child(1){grid-column:1/2;grid-row:1/2}.footer-list.svelte-1bzupy6>li.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6:nth-child(2){grid-column:1/2;grid-row:2/3}.footer-list.svelte-1bzupy6>li.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6:nth-child(3){grid-column:2/3;grid-row:1/2;margin-left:0}.footer-list.svelte-1bzupy6>li.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6:nth-child(4){grid-column:2/3;grid-row:2/3}}@media(max-width: 550px){.footer-list.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6{flex-direction:column;max-width:400px;margin:auto}.footer-list.svelte-1bzupy6 li.svelte-1bzupy6>img.svelte-1bzupy6.svelte-1bzupy6{height:auto;width:100%}}#footers-foot.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6{height:60px;background-color:#282d3d}#footers-foot.svelte-1bzupy6>div.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6{display:flex;align-items:center;justify-content:space-between;color:white}@media(max-width: 724px){#footers-foot.svelte-1bzupy6>div.svelte-1bzupy6.svelte-1bzupy6.svelte-1bzupy6{justify-content:center}}#footers-foot.svelte-1bzupy6>div.svelte-1bzupy6>p.svelte-1bzupy6.svelte-1bzupy6{font-size:15px}@media(max-width: 724px){#footers-foot.svelte-1bzupy6>div.svelte-1bzupy6>p.svelte-1bzupy6.svelte-1bzupy6{text-align:center;font-size:12px}}@media(max-width: 724px){#footers-foot.svelte-1bzupy6>div.svelte-1bzupy6>ul.svelte-1bzupy6.svelte-1bzupy6{padding:0}}#footers-foot.svelte-1bzupy6>div.svelte-1bzupy6>ul.svelte-1bzupy6>a.svelte-1bzupy6{padding:15px 15px;font-size:15px;color:white;text-decoration:none;white-space:nowrap}@media(max-width: 724px){#footers-foot.svelte-1bzupy6>div.svelte-1bzupy6>ul.svelte-1bzupy6>a.svelte-1bzupy6{display:none}}#footers-foot.svelte-1bzupy6>div.svelte-1bzupy6>ul.svelte-1bzupy6>a.svelte-1bzupy6:hover{text-decoration:underline}',
  map: null
};
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$2);
  return `<section class="${"footer-main svelte-1bzupy6"}"><div class="${"gutters"}"><ul class="${"footer-list svelte-1bzupy6"}"><li class="${"svelte-1bzupy6"}"><img${add_attribute("src", logo, 0)} alt="${"logo"}" class="${"svelte-1bzupy6"}"></li>
      <li class="${"svelte-1bzupy6"}"><h6 class="${"svelte-1bzupy6"}">Contact Information</h6>
        <a href="${"/contact"}" class="${"svelte-1bzupy6"}">(02) 8378 7698</a>
        <a href="${"mailto:mail@randallandassoc.com"}" class="${"svelte-1bzupy6"}">mail@randallandassoc.com</a>
        <a href="${"/contact"}" class="${"svelte-1bzupy6"}">Video appointments available on request</a></li>
      <li class="${"svelte-1bzupy6"}"><h6 class="${"svelte-1bzupy6"}">Practice Areas</h6>
        <a href="${"/property-and-conveyancing"}" class="${"svelte-1bzupy6"}">Property &amp; Conveyancing</a>
        <a href="${"/personal-injury"}" class="${"svelte-1bzupy6"}">Personal Injury</a>
        <a href="${"/wills-and-estates"}" class="${"svelte-1bzupy6"}">Wills &amp; Estates</a></li>
      <li class="${"svelte-1bzupy6"}"><h6 class="${"svelte-1bzupy6"}">Terms &amp; Conditions</h6>
        <a href="${"/terms-and-conditions"}" class="${"svelte-1bzupy6"}">T &amp; C&#39;s</a></li></ul></div></section>
<section id="${"footers-foot"}" class="${"svelte-1bzupy6"}"><div class="${"gutters svelte-1bzupy6"}"><p class="${"svelte-1bzupy6"}">Copyright © Randall &amp; Associates Pty Ltd, 2022. All rights reserved.</p>
    <ul class="${"svelte-1bzupy6"}"><a href="${"/"}" class="${"svelte-1bzupy6"}">Home</a>
      <a href="${"/contact"}" class="${"svelte-1bzupy6"}">Contact us</a></ul></div>
</section>`;
});
